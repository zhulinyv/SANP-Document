...
![positive_input](./images/positive_input.png)

在这里, 你可以输入你想画的一切!

### 负面提示词

![negative_input](./images/negative_input.png)
...
![noise_schedule](./images/noise_schedule.png)
...
![open_saved_path](./images/open_saved_path.png)
...
![random_nsfw_images](./images/random_nsfw_images.png)
...
![update_list_button](./images/update_list_button.png)
...
![genarate_button](./images/genarate_button.png)
...
![stand_alone](./images/stand_alone.png)
...
![file_to_add](./images/file_to_add.png)
...
![tag_to_add](./images/tag_to_add.png)

- 2. 然后, 输入提示词到此处的文本框.

![name_to_add](./images/name_to_add.png)

- 3. 输入名称和选中概率

![else_to_add](./images/else_to_Add.png)

- 4. 当选择某些文件时, 下方的参数为必填项, 请注意。

![add_button](./images/add_button.png)
...
![file_to_del](./images/file_to_del.png)
...
![add_tag](./images/add_tag.png)

在文本框中输入一些你想要的内容(支持 wildcard), 并选择内容追加到哪里。

### 其它参数

![sfw_else_setting](./images/sfw_else_setting.png)
...
其中的图片需要重命名为：(任意(不含下划线)\_(信息提取强度, 浮点型(0, 1))\_(参考强度, 浮点型(0, 1)).png)` 的格式, 例如 `hoshino-hinata_1.0_0.6`.

## CasRand

![casrand](./images/casrand.png)
...
![random_artist_tag](./images/random_artist_tag.png)
...
![random_artist_weight](./images/random_artist_weight.png)
...
![tiled_upscale_add_image](./images/tiled_upscale_add_image.png)
...
![tiled_upscale_model](./images/tiled_upscale_model.png)
...
![inpaint_draw](./images/inpaint_draw.png)
...
![draw_inpaint_draw](./images/draw_inpaint_draw.png)
...
![watermarks](./images/watermarks.png)
...
![plugin_store](./images/plugin_store.png)
